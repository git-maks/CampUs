          ...
          {calendarData.map((event) => (
            <article key={event.id} className="glass-panel relative overflow-hidden p-5">
              ...
              <div className="mb-2 flex items-start justify-between">
                <span className="inline-flex items-center gap-1 rounded-md border border-blue-200/35 bg-blue-200/15 px-2 py-1 text-xs font-semibold uppercase tracking-wider text-blue-100">
              ...
              <div className="mt-2 space-y-1 text-sm text-white/78">
                <p className="single-line inline-flex items-center gap-2">
                  <FontAwesomeIcon icon={faClock} className="text-xs text-blue-200" />
